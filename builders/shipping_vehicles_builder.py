...
from routers.queries import query_Viagem_Veiculos


def build_insert_payload(vehicles: Dict[str, Any]) -> Dict[str, Any]:
# def build_insert_payload(rowid: str) -> Dict[str, Any]:
    ...
    # drivers = query_Viagem_Vehicles(numTransacao=drivers["NUMTRANSACAO"])
