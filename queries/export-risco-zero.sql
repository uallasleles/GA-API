...
SELECT
    ...
    , TRIM(prest.DUPLIC)||'-'||TRIM(PREST.PREST)    AS numdocumento     -- Número do documento de registro no sistema
    , prest.VALOR                                   AS valor            -- Valor do título (compras parceladas: uma linha por parcela)
    -- , TO_CHAR(prest.DTDESD , 'DD/MM/YYYY')       AS dtadesdobramento -- Data em que foi efetuado o pagamento do título
