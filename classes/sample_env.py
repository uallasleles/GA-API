...
# dicionário contendo todos os parâmetros; estes são adquiridos conforme 
# necessário pelos métodos abaixo (que devem ser usados ​​em vez de consultar 
# este dicionário diretamente) e depois armazenados para que um valor não seja 
# solicitado mais de uma vez
PARAMETERS = {}
